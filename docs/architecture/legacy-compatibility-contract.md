...
- Import/Export/Backup 的 inspect/export/preview/import/local CRUD 由 M21 manifest 覆盖，使用共享 Archive schema 与 BackupTransport；自动 chat JSONL backup 明确作为可删空兼容边界；
